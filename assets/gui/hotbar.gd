...
func _process(_delta):
	...
	if Input.is_action_just_pressed("slot1"):
		...
		$current.position = $HBoxContainer/slot1.position + Vector2(3,3)
	if Input.is_action_just_pressed("slot2"):
		Glova.g_current(hotbar[1])
		$current.position = $HBoxContainer/slot2.position + Vector2(3,3)
	if Input.is_action_just_pressed("slot3"):
		Glova.g_current(hotbar[2])
		$current.position = $HBoxContainer/slot3.position + Vector2(3,3)
	if Input.is_action_just_pressed("slot4"):
		Glova.g_current(hotbar[3])
		$current.position = $HBoxContainer/slot4.position + Vector2(3,3)
	if Input.is_action_just_pressed("slot5"):
		Glova.g_current(hotbar[4])
		$current.position = $HBoxContainer/slot5.position + Vector2(3,3)
	if Input.is_action_just_pressed("slot6"):
		Glova.g_current(hotbar[5])
		$current.position = $HBoxContainer/slot6.position + Vector2(3,3)
	if Input.is_action_just_pressed("slot7"):
		Glova.g_current(hotbar[6])
		$current.position = $HBoxContainer/slot7.position + Vector2(3,3)
	if Input.is_action_just_pressed("slot8"):
		Glova.g_current(hotbar[7])
		$current.position = $HBoxContainer/slot8.position + Vector2(3,3)
