...
func _process(_delta):
	...
	if Glova.g_cooldown(-1) != 0:
		if slot == 1:
			...
			tween.tween_property($HBoxContainer/slot1/slot1_cd, "value", 0, Glova.g_cooldown(-1))
			Glova.g_cooldown(0)
		elif slot == 2:
			$HBoxContainer/slot2/slot2_cd.value = 2
			tween = get_tree().create_tween()
			tween.tween_property($HBoxContainer/slot2/slot2_cd, "value", 0, Glova.g_cooldown(-1))
			Glova.g_cooldown(0)
		elif slot == 3:
			$HBoxContainer/slot3/slot3_cd.value = 1
			tween = get_tree().create_tween()
			tween.tween_property($HBoxContainer/slot3/slot3_cd, "value", 0, Glova.g_cooldown(-1))
			Glova.g_cooldown(0)
		elif slot == 4:
			$HBoxContainer/slot4/slot4_cd.value = 1
			tween = get_tree().create_tween()
			tween.tween_property($HBoxContainer/slot4/slot4_cd, "value", 0, Glova.g_cooldown(-1))
			Glova.g_cooldown(0)
		elif slot == 5:
			$HBoxContainer/slot5/slot5_cd.value = 1
			tween = get_tree().create_tween()
			tween.tween_property($HBoxContainer/slot5/slot5_cd, "value", 0, Glova.g_cooldown(-1))
			Glova.g_cooldown(0)
		elif slot == 6:
			$HBoxContainer/slot6/slot6_cd.value = 1
			tween = get_tree().create_tween()
			tween.tween_property($HBoxContainer/slot6/slot6_cd, "value", 0, Glova.g_cooldown(-1))
			Glova.g_cooldown(0)
		elif slot == 7:
			$HBoxContainer/slot7/slot7_cd.value = 1
			tween = get_tree().create_tween()
			tween.tween_property($HBoxContainer/slot7/slot7_cd, "value", 0, Glova.g_cooldown(-1))
			Glova.g_cooldown(0)
